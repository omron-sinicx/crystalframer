...
class RegressionDatasetMP_Latticeformer(RegressionDatasetMP):
    def __init__(self, target_split, target_set=None, cell_format:CellFormat=CellFormat.RAW, post_filter=None):
        super(RegressionDatasetMP_Latticeformer, self).__init__(target_split, "latticeformer", target_set, cell_format, post_filter)
